    ...
    private void verificarSecuencia(Button boton) {
        if (botonesVibrantes.contains(boton)) {
            ...
            if (botonesPulsados.containsAll(botonesVibrantes)) {
                Toast.makeText(E.this, "¡A por otra!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(E.this, F.class);
                startActivity(intent);
                finish();
            }
        } else {
            botonesPulsados.clear();
            Toast.makeText(E.this, "Esta no es la secuencia correcta. Sigue intentándolo.", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(E.this, Dificultad.class);
            startActivity(intent);
            finish();
        }
    }
