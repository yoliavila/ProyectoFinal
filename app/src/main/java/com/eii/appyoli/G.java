    ...
    private void verificarSecuencia(Button boton) {
        if (botonesVibrantes.contains(boton)) {
            ...
            if (botonesPulsados.containsAll(botonesVibrantes)) {
                Toast.makeText(G.this, "¡Secuencia correcta! Sigue adelante.", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(G.this, H.class);
                startActivity(intent);
                finish();
            }
        } else {
            botonesPulsados.clear();
            Toast.makeText(G.this, "Esta no es la secuencia correcta. Sigue intentándolo.", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(G.this, Dificultad.class);
            startActivity(intent);
            finish();
        }
    }
